...
Orders.Count( ).Dump("Total Orders");
var q1 = from od in Orders
				 where od.Freight > 50
				 select od;
...
//
var q2 = from od in Orders
				 where od.Freight > 50 // filter
				 orderby od.Customer.CompanyName  // Orderby


				 select new {
					 OrderNum = od.OrderId,
					 CustomerName = od.Customer.CompanyName,
					 FreightCost = od.Freight,
